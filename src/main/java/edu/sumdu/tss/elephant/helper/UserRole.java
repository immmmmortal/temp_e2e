...
public enum UserRole implements RouteRole {
    ...
    public final static RouteRole[] AUTHED = {UserRole.UNCHEKED, UserRole.BASIC_USER, UserRole.PROMOTED_USER, UserRole.ADMIN, UserRole.ADVANCED_USER};
